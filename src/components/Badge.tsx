...
const SUCCESS = new Set(['مكتمل', 'منجز', 'حاضر', 'موافق', 'مدفوعة', 'مقبول', 'يعمل', 'نشط', 'جاهزة', 'تم الاستلام', 'معتمد', 'مكتملة']);
const WARNING = new Set(['قيد الانتظار', 'معلق', 'متأخر', 'تحت الفحص', 'صادرة', 'مسودة', 'متأخرة', 'قيد الرحلة']);
const DANGER = new Set(['مرفوض', 'غائب', 'ملغاة', 'ملغى', 'متوقف', 'خارج الخدمة', 'معطل', 'متعطل', 'تالف']);
