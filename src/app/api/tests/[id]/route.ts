...
// Server-side PATCH/DELETE for a single test (مدير/إداري/فني only).
...
export async function PATCH(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const updated = await databases.updateDocument(DATABASE_ID, TESTS_COLLECTION_ID, id, cleanData);
